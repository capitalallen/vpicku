...
$(document).ready(function() {
  $("#servcheck").click(function() {
    ...
    if (guideFeeOn) {
      ...
      document.getElementById("finalFee").innerHTML = "$" + Math.floor(localStorage.priceCar * 1.1 + 15*1.1);
      document.getElementById("chineseYuan").innerHTML = "RMB" + Math.floor(localStorage.priceCar * 1.1*5.2 + 15*1.1*5.2);
    }else {
      ...
      document.getElementById("finalFee").innerHTML = "$" + Math.floor(localStorage.priceCar * 1.1);
      document.getElementById("chineseYuan").innerHTML = "RMB" + Math.floor(localStorage.priceCar * 1.1*5.2);
    }
    ...
    $("#guidelistC").click(function(){ 
      ...
      document.getElementById("finalFee").innerHTML = "$" + Math.floor(localStorage.priceCar * 1.1 + 25*1.1);
      document.getElementById("chineseYuan").innerHTML = "RMB" + Math.floor(localStorage.priceCar * 1.1*5.2 + 25*1.1*5.2);
    } else {
      document.getElementById("guideFee").innerHTML = "$" + 15;
      document.getElementById("totalFee").innerHTML = "$" + Math.floor(localStorage.priceCar * 0.1 + 1.5);
      document.getElementById("finalFee").innerHTML = "$" + Math.floor(localStorage.priceCar * 1.1 + 15*1.1);
  ...
  $("#selectbut").click(function() {
    ...
    window.open("confirmchinese.html");
  });
...
function confirmload() {
  ...
  document.getElementById("finalFee").innerHTML = "$" + (localStorage.priceCar * 1 + localStorage.priceCar * 0.1);
  document.getElementById("chineseYuan").innerHTML = "RMB" + Math.floor(localStorage.priceCar * 1.1*5.2);
